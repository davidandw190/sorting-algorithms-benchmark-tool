...
def main():
    ...
    # sizes = [50, 75, 100, 200, 300, 400, 500, 600, 700, 750]
    # sizes = [500, 750, 1000] # test
    num_runs = 6

    if not os.path.exists('plots_small'):
        os.makedirs('plots_small')
    if not os.path.exists('csvs_small'):
        os.makedirs('csvs_small')
